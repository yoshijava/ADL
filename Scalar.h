#ifndef SCALAR_H_
#define SCALAR_H_
#define DECLARE_I32(x, val) Var<int> i_##x(#x, val);
#define ADD_32(x, y, z) add_32_my_isa_impl(i_##x, i_##y, i_##z);
#define ADD_32_IMM16(x, y, z) add_32_imm16_my_isa_impl(i_##x, i_##y, z);
